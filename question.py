...
questionDictionary = {
    ...
    "possible answers 2":("B) False","","B) A body that deals with breaches of the treaty of Waitangi","B) Introduction of the Waitangi tribunal","B) Perceived threat of Maori conquering the white settlers","B) False","","B) Act","B) Whanau, Hapu, Iwi","B) Pōtatau"),
    
    "possible answers 3":("","","C) A political movement","C) All stolen Maori land returned","c) Break up of the british empire","","","C) National","C) Hapu, Iwi, Whanau","C) Koroki"),
    
    "possible answers 4":("","","D) A body of law","D) Maori gaining full access to the bill of rights","D) It didn't happen","","","D) Te Pati Maori","D) Iwi, Whanau, Hapu","D) Atairangikaahu"),
    
    "correct answers":("A) True", float(16.5), "B) A body that deals with breaches of the treaty of Waitangi", "A) The Maori language act, which established Maori as a national language","A) White settlers wanting more land","B) False",int(7),"D) Te Pati Maori","A) Iwi, Hapu, Whanau","A) Tūheitia")}